...
Raspberry Pi Pico is a family of development board from [Raspberry Pi Foundation](https://www.raspberrypi.org/).
...
But Raspberry Pi Pico W alone are not able to help you begin the IoT journey. Therefore, we introduce you a [complete kit](https://myduino.com/product/myd-055/), to help you to completely embark your IoT journey.
...
In this repository, we share with you the example program using CircuitPython framework to program the RP2040 microcontroller on the Raspberry Pi Pico W, from Lab 00, the understanding of the CircuitPython modules and boards until Lab 15, connecting Raspberry Pi Pico W using MQTT protocol to [Favoriot](https://platform.favoriot.com) IoT platform.
